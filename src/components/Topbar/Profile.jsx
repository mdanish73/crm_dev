    ...
    <>
      <Popover>
        ...
        <PopoverContent className="absolute p-0 w-60 top-1 right-1 bg-[#1B2E4B] bg-opacity-80 backdrop-blur-lg rounded outline-none border-none overflow-hidden">
          ...
          <Link
            href="/"
            className="w-full h-10 px-4 py-2 gap-3 text-sm flex text-[#888EA8] hover:bg-[#1F335B]"
          >
          ...
          <Link
            href="/"
            className="w-full h-12 px-4 py-3 gap-3 text-sm flex text-[#d64a4a] hover:bg-[#1F335B] hover:text-[#4361EE]"
          >
