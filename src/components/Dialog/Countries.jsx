...
//     country: z.array(
//         z.object({
//       countryName: z.string().nonempty("Name is required"),
//       countryCode: z.string().nonempty("Code is required"),
//     })
...
//         <Button className="bg-secondaryHeading text-secondaryText hover:text-secondary_bg">Add Country</Button>
//       </DialogTrigger>
...
//           <DialogDescription>
//             <p>
//                 This form enables user submit industry
//                 data.
//             </p>
